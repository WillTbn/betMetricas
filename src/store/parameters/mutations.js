...
export function disabledParams(state, payload) {
  state.paramsCase.find((e) => (e.name === payload ? (e.disabled = true) : ""));
}
export function removeDisabledParams(state, payload) {
  state.paramsCase.find((e) =>
    e.name === payload ? (e.disabled = false) : ""
  );
}
